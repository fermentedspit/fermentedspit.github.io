<?php
/**
 * RackForms Form Library Files - get_pdf.php
 * @version 1.3
 * @author RackForms
 * @category Database
 ...
 * <img src="lib/get_pdf.php?id=<?php echo $res['id'];?>" />
 * 
 * Used in Builder File Calls as:
 * 
 * Display PDF Inline In Browser:
 * lib/get_pdf.php?id=#{id}&action=&display-method=inline
 * 
 * Display Download Prompt For PDF
 * lib/get_pdf.php?id=#{id}&action=&display-method=download
 * 
 * -----------------
 * How to use:
 * -----------------
 ...
 * lib/get_pdf.php?id=#{id}&action=name
 * 
 * 
 */
